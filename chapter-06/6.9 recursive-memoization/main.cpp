...
// Memoization for recursive functions is a bit more comples -- see
// section 6.3
...
public:
  ...
  template <class... InnerArgs> Result operator()(InnerArgs &&... args) const {
...
auto main(int argc, char *argv[]) -> int {
  ...
  auto fib_15 = fibmemo(15); // <1>
  std::cout << "15! = " << fib_15 << '\n';
  std::cout << "15! = " << fibmemo(15) << '\n'; // <2>
}
